    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="?assets=mitra&jenis=FandB">F & B</a>
          <a class="dropdown-item" href="?assets=mitra&jenis=service">Service</a>
          <a class="dropdown-item" href="?assets=mitra&jenis=rentail">Retail</a>
          <a class="dropdown-item" href="?assets=mitra&jenis=cargo">Cargo</a>
        </div>
      </li>
    </ul>
  </div>
...
<!-- <div class="wrapper"> -->
        ...
        <div id="content">
            ...
            <?php
                ...
                if($assets== 'filter_mitra'){
                    include "../assets/filter_mitra.php";
                }
                if($assets== 'tracking'){
